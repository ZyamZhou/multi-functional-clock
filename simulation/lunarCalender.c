...
uchar code1;
uchar code2;                          
uchar code3;//这里放24节气的索引
uchar code4;
uchar SolarTerm[24];
uchar lunar_month;
uchar lunar_date;
uint temp[12]={0x0800,0x0400,0x0200,0x0100,0x0080,0x0040,0x0020,0x0010,0x0008,0x0004,0x0002,0x0001};
uint symbol;
uchar sign[13]={0};
/*阳历平年和闰年*/
...
void convert(uchar year,uchar month,uchar date){
	...
	//计算天干地支
	code1=(dex_wholeYear-1864)%10;	   //天干的索引值
	code2=(dex_wholeYear-1864)%12;	   //地支的索引值 
